...
const Add_Project = () => {
    ...
    function handleClick(){
        axios.post("http://localhost:8000/project",inputs)
  ...
  <div class="container max-w-screen-lg mx-auto">
    <div>
      <h2 class="font-semibold text-xl text-yellow-600">Project Form</h2>
        ...
        <div class="grid gap-4 gap-y-2 text-sm grid-cols-1 lg:grid-cols-3">
          ...
          <div class="lg:col-span-2 ">
            <div class="grid gap-4 gap-y-2 text-sm grid-cols-1 md:grid-cols-5">
              ...
              <div class="md:col-span-5">
                <label for="date of birth">Project Date</label>
              ...
              <div class="md:col-span-5">
                <label for="gender">Task Title</label>
                <input type="text"  className="h-10 border mt-1 rounded px-4 w-full bg-gray-50" 
                  onChange={(e)=>setInputs ({...inputs,gender:e.target.value})} />
              </div>

              <div class="md:col-span-5">
                <label for="phone_number">Start Date</label>
                <input type="text" className="h-10 border mt-1 rounded px-4 w-full bg-gray-50" 
